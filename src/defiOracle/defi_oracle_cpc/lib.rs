...
#[cfg(test)]
mod tests {
    use defi_oracle_shared::{shared_types::{SwapPair, TokenOverview, InternalRateEntry, ExchangeSnapshot}, utils::process_mib_quotes};
    ...
    fn test_convert_quotes(){
        ...
        RUNTIME_STATE.with(|s|{
            let qte = InternalRateEntry{ swap_pair: SwapPair::ICP_USD, quote: 1.5};
