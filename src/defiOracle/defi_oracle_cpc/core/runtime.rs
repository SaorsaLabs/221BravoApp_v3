...
use defi_oracle_shared::shared_types::{OverviewV1, TokenOverview, TokenSwaps, InternalRates};
...
pub struct Data {
    ...
    pub mib_canisters: Vec<(String, String)>, // canister, name/ free text
...
impl Data {
    ...
    pub fn get_mib_all_canisters(&self) -> Vec<(String, String)> {
        return self.mib_canisters.clone();
    }

    pub fn add_mib_canister(&mut self, canister: String, name: String) -> String {
        self.mib_canisters.push((canister, name));
        return "MIB Canister added to store".to_string();
    }

    pub fn remove_mib_canister(&mut self, canister: String) -> String {
        self.mib_canisters.retain(|x| &x.0 != &canister);
        return "MIB Canister has been removed".to_string();
    }
