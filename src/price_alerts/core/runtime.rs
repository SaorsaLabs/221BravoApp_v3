...
//use crate::timers::processing::OHLCBucket;
...
pub struct Data {
    ...
    pub alerts_pending: Vec<InputAlert>,
    pub icp_fetch_count: Option<u32>,
    pub icp_last_price: Option<f64>
}
...
impl Data {
    ...
    pub fn set_oracle_id(&mut self, id: String) -> String {
        self.oracle_id = Some(id);
        return String::from("Oracle ID Set");
    }

    pub fn get_oracle_id(&self) -> Option<String> {
        return self.oracle_id.clone();
    }
}