...
use super::utils::{get_subaccount_from_principal, get_multiple_subaccounts_from_principal};
...
pub fn get_single_account_impl(inpt_principal: String, inpt_subaccount: u8) -> String {
    let sub_ac = get_subaccount_from_principal(inpt_principal, inpt_subaccount);
    return sub_ac;
}

pub fn get_multiple_account_impl(inpt_principal: String, inpt_start: u8, inpt_number: u8) -> Vec<String> {
