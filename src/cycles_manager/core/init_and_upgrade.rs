...
use super::constants::CHECK_DAYS;
...
fn init(admin: String) {
    ...
    data.set_topup_level(10000000000000); // 10T cycles
    data.set_topup_amount(10000000000000); // 10T cycles
    data.set_check_days(CHECK_DAYS as u8); 
