...
# New Swap Input
initQuote=0.0071 # <== DONT FORGET THIS !!
# token 1
token1Ticker="ICL"
token1Ledger="hhaaz-2aaaa-aaaaq-aacla-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="2gxp3-pqaaa-aaaag-qdkhq-cai"
mkt1ReverseCross=false
mkt1UnitSize=1

# SONIC
addSONIC=false # <== TRUE TO ADD
mkt2Canister=""
...
mkt3Canister="3rrzb-lyaaa-aaaar-qad6q-cai"
