...
# New Swap Input
initQuote=0.414 # <== DONT FORGET THIS !!
# token 1
token1Ticker="NTN"
token1Ledger="f54if-eqaaa-aaaaq-aacea-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="kv5pw-kyaaa-aaaag-qcyya-cai"
...
mkt3Canister="zco2b-daaaa-aaaar-qadqa-cai"
