...
# New Swap Input
initQuote=0.025 # <== DONT FORGET THIS !!
# token 1
token1Ticker="SONIC"
token1Ledger="qbizb-wiaaa-aaaaq-aabwq-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="jknac-2aaaa-aaaag-qcmfq-cai"
...
mkt3Canister="4qxnm-tyaaa-aaaar-qadoq-cai"
