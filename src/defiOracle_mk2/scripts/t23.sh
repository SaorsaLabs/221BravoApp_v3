...
# New Swap Input
initQuote=0.00042 # <== DONT FORGET THIS !!
# token 1
token1Ticker="DKP"
token1Ledger="zfcdd-tqaaa-aaaaq-aaaga-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="ijd5l-jyaaa-aaaag-qdjga-cai"
...
mkt3Canister="3wq7v-gaaaa-aaaar-qad6a-cai"
mkt3ReverseCross=false
mkt3UnitSize=100000000
