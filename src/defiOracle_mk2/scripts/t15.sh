...
addToMibs=true
mibICPSWAP="j7dmq-lqaaa-aaaak-qc6iq-cai"
mibSONIC="jrbby-qaaaa-aaaak-qc6jq-cai"
mibICDEX="a77je-3iaaa-aaaak-qcyfq-cai"

# New Swap Input
initQuote=206.129 # <== DONT FORGET THIS !!
# token 1
token1Ticker="CKETH"
token1Ledger="ss2fx-dyaaa-aaaar-qacoq-cai"
token1decimals=18
# token 2
token2Ticker="ICP"
...
mkt1Canister="angxa-baaaa-aaaag-qcvnq-cai"
mkt1ReverseCross=true
mkt1UnitSize=1

# SONIC
addSONIC=true # <== TRUE TO ADD
mkt2Canister="3xwpq-ziaaa-aaaah-qcn4a-cai"
mkt2ReverseCross=true
mkt2UnitSize=1

# IC LIGHT
addICLIGHT=true # <== TRUE TO ADD
mkt3Canister="4zugq-fqaaa-aaaar-qadpa-cai"
mkt3ReverseCross=false
mkt3UnitSize=1000000000000000
