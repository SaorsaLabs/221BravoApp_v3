...
# New Swap Input
initQuote=0.0033 # <== DONT FORGET THIS !!
# token 1
token1Ticker="GLDGOV"
token1Ledger="tyyy3-4aaaa-aaaaq-aab7a-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="k46ek-4qaaa-aaaag-qcyzq-cai"
...
mkt3Canister="zfp4v-oyaaa-aaaar-qadqq-cai"
