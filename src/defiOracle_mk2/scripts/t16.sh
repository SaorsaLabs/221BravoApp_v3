...
# New Swap Input
initQuote=0.0015 # <== DONT FORGET THIS !!
# token 1
token1Ticker="TRAX"
token1Ledger="46vae-iiaaa-aaaar-qadpq-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="mzv7v-5qaaa-aaaag-qcypq-cai"
...
mkt3Canister="krtvm-uqaaa-aaaak-afhcq-cai"
