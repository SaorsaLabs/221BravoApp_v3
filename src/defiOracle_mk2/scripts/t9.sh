...
# New Swap Input
initQuote=0.000061 # <== DONT FORGET THIS !!
# token 1
token1Ticker="GHOST"
token1Ledger="4c4fd-caaaa-aaaaq-aaa3a-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="dwahc-eyaaa-aaaag-qcgnq-cai"
...
mkt3Canister="5b5tt-lqaaa-aaaar-qadla-cai"
mkt3ReverseCross=false
mkt3UnitSize=10000000000
