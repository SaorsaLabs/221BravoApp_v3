...
# New Swap Input
initQuote=0.0018 # <== DONT FORGET THIS !! ******************************* <==
# token 1
token1Ticker="ICS"
token1Ledger="ca6gz-lqaaa-aaaaq-aacwa-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="uizni-yiaaa-aaaag-qjrca-cai"
...
mkt3Canister="ylwbz-ziaaa-aaaar-qaeka-cai"
