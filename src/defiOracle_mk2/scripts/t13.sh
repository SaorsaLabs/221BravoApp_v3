...
# New Swap Input
initQuote=0.0075 # <== DONT FORGET THIS !!
# token 1
token1Ticker="NUA"
token1Ledger="rxdbk-dyaaa-aaaaq-aabtq-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="irtmd-myaaa-aaaag-qcl4q-cai"
...
mkt3Canister="4xwly-6aaaa-aaaar-qadoa-cai"
