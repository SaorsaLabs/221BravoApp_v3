...
# New Swap Input
initQuote=0.0059 # <== DONT FORGET THIS !!
# token 1
token1Ticker="ICX"
token1Ledger="4fq4b-sqaaa-aaaar-qadna-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="m3don-saaaa-aaaag-qclga-cai"
...
mkt3Canister="5xpmz-zyaaa-aaaak-ae67q-cai"
