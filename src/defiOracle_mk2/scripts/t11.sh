...
# New Swap Input
initQuote=0.0036 # <== DONT FORGET THIS !!
# token 1
token1Ticker="CAT"
token1Ledger="uf2wh-taaaa-aaaaq-aabna-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="dggvb-byaaa-aaaag-qckcq-cai"
...
mkt3Canister="4lsrj-jaaaa-aaaar-qadma-cai"
