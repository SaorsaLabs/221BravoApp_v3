...
# New Swap Input
initQuote=0.0007 # <== DONT FORGET THIS !!
# token 1
token1Ticker="OGY"
token1Ledger="rd6wb-lyaaa-aaaaj-acvla-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="oxpo6-vaaaa-aaaag-qcmxq-cai"
...
mkt3Canister="7aehk-pyaaa-aaaar-qadgq-cai"
