...
# New Swap Input
initQuote=9.46 # <== DONT FORGET THIS !!
# token 1
token1Ticker="SNEED"
token1Ledger="hvgxa-wqaaa-aaaaq-aacia-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="osyzs-xiaaa-aaaag-qc76q-cai"
...
mkt3Canister="zmmxj-yqaaa-aaaar-qadra-cai"
