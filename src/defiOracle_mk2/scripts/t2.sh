...
# New Swap Input
initQuote=0.036 # <== DONT FORGET THIS !!
# token 1
token1Ticker="CHAT"
token1Ledger="2ouva-viaaa-aaaaq-aaamq-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="ne2vj-6yaaa-aaaag-qb3ia-cai"
...
mkt3Canister="52ypw-riaaa-aaaar-qadjq-cai"
