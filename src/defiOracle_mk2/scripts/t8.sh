...
# New Swap Input
initQuote=0.00049 # <== DONT FORGET THIS !!
# token 1
token1Ticker="BOOM"
token1Ledger="vtrom-gqaaa-aaaaq-aabia-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="fdno6-ayaaa-aaaag-qckuq-cai"
...
mkt3Canister="4mtx5-eyaaa-aaaar-qadmq-cai"
