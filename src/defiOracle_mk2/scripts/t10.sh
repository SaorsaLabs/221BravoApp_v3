...
# New Swap Input
initQuote=0.0034 # <== DONT FORGET THIS !!
# token 1
token1Ticker="HOT"
token1Ledger="6rdgd-kyaaa-aaaaq-aaavq-cai"
token1decimals=8
# token 2
token2Ticker="ICP"
...
mkt1Canister="rxwy2-zaaaa-aaaag-qcfna-cai"
...
mkt3Canister="5i6yp-5yaaa-aaaar-qadkq-cai"
