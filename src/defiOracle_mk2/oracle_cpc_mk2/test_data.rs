use oracle_shared_mk2::shared_types::{TokenOverview, OverviewV1, ExchangeSnapshot, Marketplace};
...
pub fn vec_exchange_snapshots() -> Vec<ExchangeSnapshot> {
    ...
    ret.push(ExchangeSnapshot { 
        snapshot_time: 1672531200000, // 01/01/23 00:00
        swap_pair: String::from("CKBTC/ICP"), 
        exchange: Marketplace::ICDEX, 
        price: 8258.0, 
        bid: 825800000000, 
        ask: 825800000000, 
    ...
    ret.push(ExchangeSnapshot { 
        snapshot_time: 1672531200000, // 01/01/23 00:00
        swap_pair: String::from("SNS1/ICP"), 
        exchange: Marketplace::ICDEX, 
        price: 420.0, 
        bid: 42000000000, 
        ask: 42000000000, 
