export const priceStoreMk2IDL = ({ IDL }) => {
    ...
    return IDL.Service({
      ...
      'add_cross' : IDL.Func([IDL.Text], [IDL.Opt(IDL.Nat64)], []),
      'deposit_cycles' : IDL.Func([], [], []),
      'get_all_authorised' : IDL.Func([], [IDL.Vec(IDL.Text)], ['query']),
      'get_all_change_data' : IDL.Func([], [IDL.Vec(PriceChangeData)], []),
      'get_all_crosses' : IDL.Func([], [IDL.Vec(IDL.Text)], []),
