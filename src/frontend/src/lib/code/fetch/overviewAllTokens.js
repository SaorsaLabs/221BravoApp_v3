...
import { getAllTokenData, combinePrincipalSubAccount, parsePrincipalSubAccountString, processPromises } from "../utils";
...
export async function getOverviewDataAllTokens(searchInput){
    ...
    for(i=0; i<searchArLen; i++){
        ...
        jobArray.push(actor.get_overview_by_id(searchAR[i].input))
    }
    // process futures
