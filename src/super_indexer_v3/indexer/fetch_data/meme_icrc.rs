use candid::Nat;
use crate::{
    core::{runtime::RUNTIME_STATE, utils::{canister_call, log, nat_to_u128, nat_to_u64}}, 
    indexer::{
        constants::{MAX_TOTAL_DOWNLOAD, MAX_TRANSACTION_BATCH_SIZE}, 
...
use super::{
    ...
    meme_icrc_types::{Account, ArchivedTransaction, GetTransactionsRequest1, GetTransactionsResponse, Transaction, TransactionRange, DEFAULT_SUBACCOUNT}
};
...
async fn meme_download_chunk(start: u64, length: u64, ledger_id: &str) -> Result<Vec<ProcessedTX>, String> {
    let req = GetTransactionsRequest1 {
...
async fn get_transactions_from_archive_t3 (archived: &ArchivedTransaction) -> Result<Vec<ProcessedTX>, String> {
